...
const Home = () => {
  return (
    <div className='min-h-screen pt-16 flex flex-col justify-center'>
      <section className='flex flex-col-reverse lg:grid'>
        <section className='grid lg:justify-items-center px-2 lg:px-16'>
          ...
          <p className='pb-14  md:px-24 text-lg lg:text-3xl text-center'>
